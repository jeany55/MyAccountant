...
L["option_income_panel_hover_max"] = "Макс. количество зон, отображаемых в подсказке при наведении курсора"
...
L["option_income_panel_bottom_desc"] = "Отображает текущее количество золота и кнопки аддона в нижней части панели доходов"

L["option_income_panel_button_1"] = "Действие кнопки 1"
L["option_income_panel_button_1_desc"] = "Что делать при нажатии на первую кнопку в панели доходов"
L["option_income_panel_button_2"] = "Действие кнопки 2"
L["option_income_panel_button_2_desc"] = "Что делать при нажатии на вторую кнопку в панели доходов"
L["option_income_panel_button_3"] = "Действие кнопки 3"
L["option_income_panel_button_3_desc"] = "Что делать при нажатии на третью кнопку в панели доходов"
...
L["option_hide_zero_desc"] = "Если доход/расход/чистая прибыль равны нулю, скрыть строку с валютой, чтобы не отображалось 0 меди."

L["option_minimap"] = "Показать кнопку на миникарте"
L["option_minimap_desc"] = "Показывает/скрывает кнопку на миникарте"

L["option_color_income"] = "Цветовое кодирование доходов/расходов в панели доходов"
L["option_color_income_desc"] = "Включить цветовое кодирование доходов и расходов в панели доходов (для каждого источника)"

L["option_gold_per_hour"] = "Показывать доход золота в час"
L["option_gold_per_hour_desc"] = "Показывать заработанное золото в час во всплывающей подсказке миникарты"
...
L["option_minimap_right_click_desc"] = "Какое поведение должно быть при ПКМ на иконке миникарты"
...
L["option_close_entering_combat_desc"] = "Если включено, панель доходов будет закрыта (если открыта) при входе в бой"

L["option_show_all_sources"] = "Скрывать неактивные источники"
L["option_show_all_sources_desc"] = "Показывать в окне доходов только те источники, у которых есть доход или расход"

L["option_income_panel_default_sort"] = "При открытии панели сортировать по"
L["option_income_panel_default_sort_desc"] = "Как автоматически сортировать доходы/расходы при открытии панели доходов"
...
L["option_income_panel_grid_desc"] = "Показывать или нет линии сетки, имитирующие таблицу"

-- Options, sources
L["option_income_sources"] = "Активные источники дохода"
L["option_income_sources_desc"] = "Какие источники дохода отслеживать. Если не отслеживаются, они будут сгруппированы в категории 'Прочее'"
L["option_income_sources_additional_1"] = "Неактивные источники будут учтены в 'Прочее'"
L["option_income_sources_additional_2"] = "Некоторые источники могут быть недоступны в вашей версии WoW"
...
L["option_clear_session_data_desc"] = "Удалить все данные о доходах/расходах для текущей сессии. Дневные доходы останутся нетронутыми."
L["option_clear_session_data_confirm"] = "Это очистит все данные вашей сессии. Вы уверены, что хотите это сделать?"

L["option_clear_character_data"] = "Очистить все данные для этого персонажа"
L["option_clear_character_data_desc"] = "Удалить все данные о доходах/расходах только для этого персонажа. Данные других персонажей останутся нетронутыми. |cffff0000Это необратимо!|r"
L["option_clear_character_data_confirm"] = "Это |cffff0000навсегда очистит все данные для вашего персонажа|r. Это нельзя отменить. Вы уверены, что хотите это сделать?"

L["option_clear_all_data"] = "Очистить все данные"
L["option_clear_all_data_desc"] = "Удалить все данные о доходах/расходах для этого аддона. |cffff0000Это необратимо!|r"
L["option_clear_all_data_confirm"] = "Это |cffff0000навсегда очистит все данные для всех ваших персонажей, начиная с нуля|r. Это нельзя отменить. Вы уверены, что хотите это сделать?"

-- Options, developer options
L["option_debug_messages"] = "Показывать сообщения отладки"
L["option_debug_messages_desc"] = "Показывать в чате сообщения, предназначенные для целей отладки"

...
* **Report functionality**: Create custom reports by selecting specific days. Right-click on calendar days to add them to a report, or use `/mya report` commands to build reports programmatically. Shift + right click on the calendar to view your report or use `/mya report show`.
...
* Fixed tab not remembering properly when reopening income frame
